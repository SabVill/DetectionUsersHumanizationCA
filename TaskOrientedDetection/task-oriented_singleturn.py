...
if __name__ == '__main__':
    ...
    #
    turn = "I am looking for a restaurant"
    ...
    #
    # y_pred CONTAINS THE CLASSIFICATION RESULT
    #
    # You can store them in a data structure or user model
    # Here it is only printed
    #
